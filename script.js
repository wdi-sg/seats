...
var inputHappened = function(currentInput){
    if(currentInput !== "buy first class" && currentInput !== "buy economy class" && currentInput !== "buy business class"){
        ...
        if(seatCounter < 7){
          economyClassPrice = economyClassPrice + (economyClassPrice / 100 * (3 * seatCounter));
          return `Price: $${economyClassPrice}, ${economySeat - seatCounter} seats left.`;
        }else if(seatCounter > 6 && seatCounter < 15){
          economyClassPrice = economyClassPrice + (economyClassPrice / 100 * (5 * seatCounter));
          return `Price: $${economyClassPrice}, ${economySeat - seatCounter} seats left.`;
      ...
      if(currentInput === "buy business class"){
        ...
        if(businessClassSeatCounter < 4){
          businessClassPrice = businessClassPrice + (businessClassPrice / 100 * (6 * businessClassSeatCounter));
          ...
          businessClassPrice = businessClassPrice + (businessClassPrice / 100 * (10 * businessClassSeatCounter));
          return `Price: $${businessClassPrice}, ${businessClassSeat - businessClassSeatCounter} seats left.`;
      ...
      if(currentInput === "buy first class"){
        ...
        if(firstClassSeatCounter < 4){
          firstClassPrice = firstClassPrice + (firstClassPrice / 100 * (15 * firstClassSeatCounter));

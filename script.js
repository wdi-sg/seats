    ...
    var partOnePriceIncrease = 1.03;
    var partTwoPriceIncrease = 1.05;
    var currentPrice = 50;
    var ticketsLeft = 10;
//actual functions runnin
    ...
    var twodecpx = nextSeatPrice.toFixed(2)
    console.log ("next seat price: " + twodecpx);
    currentPrice = twodecpx;
    seatSold = (seatSold + 1);
  ...
  return output;
    ...
    var twodecpx1 = nextSeatPrice1.toFixed(2)
    console.log ("next seat price: " + twodecpx1);
    currentPrice = twodecpx1;
    seatSold = (seatSold + 1);
        ticketsLeft = (ticketsLeft -1);
    var output = "We are left with: " + ticketsLeft + "tickets!";
  return output;
    ...
    currentPrice = nextSeatPrice2.toFixed(2)
    seatSold = (seatSold + 1);
        ticketsLeft = (ticketsLeft -1);
    var output = "We are left with: " + ticketsLeft + "tickets!";
  return output;
...
/*below are the codes for part 2
